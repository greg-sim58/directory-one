...
const PATTERNS = [
  ...
  { name: "Generic Bearer header", re: /(?:authorization["'\s:]+)?Bearer\s+[A-Za-z0-9._\-]{24,}/gi },
  { name: "Generic high-entropy assignment", re: /(?:api[_-]?key|secret|token|password|passwd)\s*[:=]\s*['"]([A-Za-z0-9._\-+/=]{24,})['"]/gi },
];
